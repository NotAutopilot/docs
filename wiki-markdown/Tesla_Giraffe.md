...
```
Tesla Giraffe is not needed with the latest versions of Tesla Unity OpenPilot. This equipment was used in the past to connect the EPAS Harness to the OBD2 port and the Panda. With the release of v0.8.13 this device was replaced by the Tinkla OBD-C Adapter
```
...
- has the Comma RJ45 FakeEthernet CAN connector to connect the[Comma Pedal](The_Comma.ai_Pedal.md)
