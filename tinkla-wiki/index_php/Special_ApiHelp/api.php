...
<link href="/load.php?debug=false&amp;lang=en&amp;modules=ext.pygments%7Cmediawiki.apipretty%7Cmediawiki.legacy.commonPrint%2Cshared%7Cmediawiki.skinning.interface&amp;only=styles&amp;skin=apioutput" rel="stylesheet"/>
...
<div id="mw-content-text"><div class="api-pretty-header"><p>This is the HTML representation of the JSON format. HTML is good for debugging, but is unsuitable for application use.
</p><p>Specify the <var>format</var> parameter to change the output format. To see the non-HTML representation of the JSON format, set <a class="external text" href="https://tinkla.us/api.php?action=help&amp;modules=api.php&amp;format=json" rel="nofollow noreferrer noopener" target="_blank"><kbd>format=json</kbd></a>.
</p><p>See the <a class="extiw" href="https://www.mediawiki.org/wiki/API" title="mw:API">complete documentation</a>, or the <a href="api.php">API help</a> for more information.
    ...
    <span class="s2">"error"</span><span class="o">:</span> <span class="p">{</span>
        <span class="s2">"code"</span><span class="o">:</span> <span class="s2">"badmodule"</span><span class="p">,</span>
        <span class="s2">"info"</span><span class="o">:</span> <span class="s2">"The module \"main\" does not have a submodule \"api.php\"."</span><span class="p">,</span>
        <span class="s2">"*"</span><span class="o">:</span> <span class="s2">"See https://tinkla.us/api.php for API usage. Subscribe to the mediawiki-api-announce mailing list at &amp;lt;https://lists.wikimedia.org/mailman/listinfo/mediawiki-api-announce&amp;gt; for notice of API deprecations and breaking changes."</span>
    <span class="p">}</span>
<span class="p">}</span>
</pre></div>
...
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":40570});});</script> </body></html>
