# Tesla Model S pre AP OBD2 port

pre AP Tesla Model S OBD2 port with pins 1 and 9 populatedpre AP Tesla Model S OBD2 port without pins 1 and 9 populated
...
This [video](https://www.youtube.com/watch?v=Ui Qved6gt2U) for a different product shows you what you have to do in order to remove the driver side foot-well cover. Take your time and watch the video first. The process is not complicated if you just follow it step by step.
