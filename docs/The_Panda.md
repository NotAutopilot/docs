...
The Panda is an OBD II dongle created by Comma.ai. It allows the EON to talk to the car viaCAN busmessaging. It supports 3 CAN buses, 2 LIN buses, and 1 GMLAN.
...
- White Panda: $99 USD - The white panda has WiFi and USB capabilities and can work directly with your computer runningCabana.
- Grey Panda: $199 USD - The grey panda has high precision GPS (to be used with maps integration) but no wifi and can't be used withCabana.
