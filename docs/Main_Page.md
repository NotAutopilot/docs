...
If you're looking for instructions for the old versions of Open Pilot that run on EON with white or gray panda, that page is availablehere.
...
1. Open Pilot for pre AP Tesla Model S
2. Open Pilot for Tesla Model S/X with AP1
3. Open Pilot for Tesla Model S/X with AP2
