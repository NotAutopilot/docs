...
- 2000 – passed preliminary exams for my Ph D and began working on my dissertation: “Dynamical Systems in 3 Dimensional Particle Billiards”, which was focusing on particle collision in certain conditions.
...
- Work on [Tesla Open Pilot branch](Main_Page.md)
- Create and maintain the [Tinkla Buddy](Tinkla_Buddy.md) , keeping it in line with the changes from Tesla
- Work on the next product,[Tinkla Relay](Tinkla_Relay.md) (Due October 2020) for the whole S3XY lineup
- Taking my car frunk and dashboard apart many times to install Open Pilot harness and mods
- Taking my car completely apart to install the AP1 hardware (complete with i Booster, ESP2, Park sensors, radar, etc) and many other add-ons
- Gettingcompletely frustrated with the Tesla Service Center